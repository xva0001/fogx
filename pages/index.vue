<template>
  <div class="w-full" :class="isDark ? 'text-white' : 'text-black'">
    ...
    <section class="hero text-center py-16" :class="isDark ? 'text-white' : 'text-white'">
      <div class="max-w-2xl mx-auto">
        ...
        <div class="flex justify-center gap-4 mt-6">
          <nuxt-link class="btn btn-neutral" :class="isDark ? 'text-white' : ' text-white'">
            Join Now
          </nuxt-link>
    ...
    <section id="features" class="py-12 container rounded-lg" :class="isDark ? 'bg-gray-600 text-white' : 'bg-gray-100 text-black'">
      <h2 class="text-3xl font-bold text-center mb-8" :class="isDark ? 'text-gray-200' : 'text-black'">
        Why Choose MsgFog?
      </h2>
...
@media (min-width:1770px) and (max-width: 2112px) {
    .container {
        width: 72%;
    }
}
